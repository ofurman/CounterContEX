...
| 4 | [Experiment 1: single-feature estimation](stages/04-exp1-single-feature.md) | DONE | MOONS: WEAK (1/2 beats marginal, calib 0.70); HELOC: PASS (15/23=65% beats marginal, calib 0.60). Overall gate: PASS — proceed to Stage 5 | b9ca03f |
