...
| A qualitative artifact needs factual feature values as well as candidate arrays; when historical artifacts omit factuals, reconstruct the pinned case and require its `case_id` to match before inverse-transforming values. | [paper-experiment-campaign](paper-experiment-campaign/index.md) | 2026-09-07 |
| Confidence conditioning and a higher generation threshold are different scientific axes: this campaign found the threshold raised achieved probability, while conditioning mainly preserved coverage/proximity and cost much more runtime. | [paper-experiment-campaign](paper-experiment-campaign/index.md) | 2026-09-07 |
| Foundation-model constructors can silently advance their default model generation; checkpoint-backed scientific identity must pin the model version, content hashes, and backend implementation explicitly. | [paper-experiment-campaign](paper-experiment-campaign/index.md) | 2026-09-07 |
| Counterfactual runtime is configuration-dependent enough that historical per-dataset projections can invert: the frozen C3 E10 Lending Club cell took 1,052 s rather than the older full-reference cell's 7.64 h. | [paper-experiment-campaign](paper-experiment-campaign/index.md) | 2026-09-07 |
