...
def generate_tabicl_counterfactuals(
    ...
    *,
    ...
    print(
        ...
        f"candidate_mode={candidate_mode}, temperature={temperature}, "
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Default: moons=100, heloc/audit=50; use -1 for the full test split.",
    )
    parser.add_argument(
        "--context-labels",
        choices=["disc", "data"],
    ...
    datasets = ["moons", "heloc", "audit"] if args.dataset == "all" else [args.dataset]
