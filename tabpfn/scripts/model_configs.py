...
def get_diff_counterfactual():
    """ "
    Returns the configuration parameters for counterfactual pair generation via the SCM prior.
    These control how perturbations are applied and how pairs are generated.
    """
    diff_counterfactual = {
        ...
        "perturbation_prob": {"distribution": "uniform", "min": 0.1, "max": 0.5},
        ...
        "gradient_step_size": {"distribution": "uniform", "min": 0.01, "max": 0.5},
        "fixed_magnitude_k": {"distribution": "uniform", "min": 0.5, "max": 3.0},
    }
    return diff_counterfactual
